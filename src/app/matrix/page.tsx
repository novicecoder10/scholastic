  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-10 sm:px-8">
      ...
      <p className="text-muted mt-1 mb-6 text-sm">
        Rows are your uploaded papers, columns are the fields you care about, and every filled cell
        carries the page and the sentence it came from. Add papers in the{" "}
